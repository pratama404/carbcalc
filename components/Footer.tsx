  ...
  const socialLinks = [
    {
      name: "Instagram",
      icon: Instagram,
      href: "https://www.instagram.com/thegeotera/",
      color: "hover:text-pink-500",
    },
    {
      name: "X",
      icon: Twitter,
      href: "https://x.com/thegeotera",
      color: "hover:text-blue-400",
    },
    {
      name: "YouTube",
      icon: Youtube,
      href: "https://www.youtube.com/channel/UCr5W2EpnCGTsDX7iab6CDBA",
      color: "hover:text-red-500",
    },
    {
      name: "Telegram",
      icon: Send,
      href: "https://t.me/thegeotera",
      color: "hover:text-blue-500",
    },
    {
      name: "LinkedIn",
      icon: Linkedin,
      href: "https://www.linkedin.com/in/geotera-carbon-air-7800aa329/",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm sm:text-base text-gray-300 mb-4 sm:mb-6 leading-relaxed">
              Join millions of users worldwide in tracking, reducing, and
              offsetting their carbon footprint. Together, we can make a
              meaningful impact on our planet's future.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-400">
              <div className="flex items-center">
                ...
                <span>geoterateam@gmail.com</span>
              </div>

              <div className="flex items-center">
                <Phone className="w-4 h-4 mr-2" />
                <a
                  href="https://wa.me/6289676011352"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:underline text-gray-400"
                >
                  Chat only via WhatsApp
                </a>
              </div>
