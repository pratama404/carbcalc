...
export default function CarbonCalculator({ onCalculate, loading }: Props) {
  ...
  const calculateRealTimeImpact = useCallback(() => {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-xl border">
        <div className="text-center mb-4">
          ...
          <div className={`text-3xl font-bold transition-all duration-500 ${realTimeImpact.total < 5 ? 'text-green-600' :
          ...
          {[
            ...
            return (
              <div key={key} className="text-center">
                <Icon className={`w-6 h-6 mx-auto mb-2 ${completedSections.includes(key) ? 'text-gray-700' : 'text-gray-400'
                  }`} />
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Transportation */}
        <div className={`bg-white p-4 sm:p-6 rounded-lg card-shadow transition-all duration-300 ${activeSection === 'transportation' ? 'ring-2 ring-blue-500 shadow-lg' : ''
          } ${completedSections.includes('transportation') ? 'border-l-4 border-green-500' : ''}`}>
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <div className="flex items-center">
              <Car className={`w-5 h-5 sm:w-6 sm:h-6 mr-2 transition-colors ${completedSections.includes('transportation') ? 'text-green-600' : 'text-blue-500'
                }`} />
            ...
            <div className="flex items-center space-x-2">
              <div className={`px-2 py-1 rounded-full text-xs font-medium ${realTimeImpact.transportation < 2 ? 'bg-green-100 text-green-700' :
        ...
        <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-xl">
          ...
          <button
            ...
            className={`w-full py-4 px-6 rounded-lg font-semibold flex items-center justify-center transition-all duration-300 ${completedSections.length === 0 ?
            ...
            <div className="mt-4 text-center">
              <p className="text-xs text-gray-500">
                ...
                {realTimeImpact.total > 0 && (
                  <span className={`ml-2 ${realTimeImpact.total < 5 ? 'text-green-600' :
                      realTimeImpact.total < 15 ? 'text-yellow-600' : 'text-red-600'
                    }`}>
